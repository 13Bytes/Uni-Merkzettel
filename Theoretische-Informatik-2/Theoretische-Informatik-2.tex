...
\begin{multicols}{3}
    ...
    \begin{itemize}
        \item  rekursiv Aufzählbar: $\exists f: \mathbb{N} \rightarrow \Sigma^* $ \hspace{1pt}:\hspace{1pt}  $A = \{ f(n) | n \in \mathbb{N} \}$
        \item $A$ ist Typ 0
    ...
    \vspace*{8pt}
    (für alle $f: \mathbb{N}\rightarrow \mathbb{N}, \forall n: f(n)\geq n$)
    \textcolor{blue}{
        $\textrm{DTIME}(f)\subseteq  \textrm{NTIME}(f) \subseteq \textrm{DSPACE}(f)$\\
        $\textrm{DSPACE}(f)\subseteq  \textrm{NSPACE}(f) \subseteq \textrm{DTIME}(2^{\mathcal{O}(f)})$ } - expon. Blowup\\
    $\Rightarrow \textrm{DSPACE}(f)\subseteq \textrm{DTIME}(2^{\mathcal{O}(f)}$
    ...
    \vspace*{8pt}
    \textcolor{blue}{
        $\textrm{NSPACE}(s)\subseteq \textrm{DSPACE}(s^2)$\\
        $\sim$ \textbf{Satz von Savitch}\\
    }
    (mit $s \in \Omega(\log n)$)
    ...
    Beweis für $s_1\notin \Omega(s_2): \quad \forall c>0: \exists a\in \mathbb{N}: s_1(a) < c\cdot c_2(b)$
    ...
    \begin{tabular}{|l|llllllllll|}
        \hline
                       ...
                       & \rot{\begin{tabular}[c]{@{}l@{}}$ L(G) = L_1 \cap L_2 $\\ G ist Type-2\end{tabular}}
                       ...
                       & \rot{Stern}
        \\ \hline
        Typ-3 Reg      &                                                                                      &     &     &     &     & \OK & \OK & \OK & \OK & \OK \\\hline
